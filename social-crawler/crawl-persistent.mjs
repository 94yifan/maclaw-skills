...
// Create a copy of chrome profile for playwright
const profileDir = '/tmp/chrome-persistent-profile-' + Date.now();
console.log('Creating profile at:', profileDir);
execSync('cp -R "/Users/yifansmacmini/Library/Application Support/Google/Chrome" "' + profileDir + '"', { timeout: 30000 });
...
// Clean up profile
execSync('rm -rf "' + profileDir + '"', { timeout: 10000 });
