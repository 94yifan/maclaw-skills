...
const report = generateReport(results, targetDate);
const today = new Date();
const outFile = 'memory/weibo_daily_' + today.getFullYear() + '-' + String(today.getMonth() + 1).padStart(2, '0') + '-' + String(today.getDate()).padStart(2, '0') + '.md';
