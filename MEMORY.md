...
每次创建新 skill 后，必须执行以下汇报动作：

**1. 汇报内容（三点，缺一不可）**
- 这个 skill 用来做什么
- 具体工作 SOP（详细步骤 + 具体命令）
- 未来可复用价值（为什么值得写进 skill，而不是一次性的）


**2. 汇报格式**
用清晰的语言向逸凡说明，不使用清单体，用描述性段落。

**3. 汇报后动作**
- 备份到 GitHub（yifanli94/maclaw-skills）
- 如 skill 涉及新的系统行为或配置变更，更新 MEMORY.md
- 如 skill 包含新的工作流或注意事项，更新 SOUL.md 对应章节

**4. 汇报时机**
skill 创建完成后立即汇报，不要等到下次对话。
